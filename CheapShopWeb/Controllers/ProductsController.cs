...
namespace CheapShopWeb.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,name,source,price,photo_link,product_link,group")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,name,source,price,photo_link,product_link,group")] Product product)
        {
            if (ModelState.IsValid)
            {
